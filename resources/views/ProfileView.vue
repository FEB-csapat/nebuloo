        ...
        <div>
            ...
            <div v-else>
                <div  class="row bg-light mt-3 mb-2 rounded-3 p-3 shadow">
                    ...
                    <div
                        v-if="(isAdmin && !userIsAdmin && !isMyProfile) || (isMod && !userIsAdmin && !userIsMod && !isMyProfile)">
                        <h2 v-if="isAdmin">
                            Admin panel:
                        </h2>
                        <h2 v-if="isMod">
                        ...
                        <div class="row my-2 text-center">
                            <div class="col-4">
                                <button class="btn btn-info" name="edituserprofile" @click="navigateToEditProfileView()">Profil
                                    szerkesztése</button>
                            </div>
                            <div class="col-4">
                                <button v-if="userData != null && !userData.banned" name="banuserprofile" class="btn btn-danger"
                                    @click="banUser()">Felhasználó kitiltása</button>
                                <button v-else class="btn btn-danger" @click="unbanUser()">Felhasználó kitiltásának
                                    feloldása</button>
                            </div>
                            <div class="col-4" v-if="isAdmin">
                                <button class="btn btn-danger" name="deleteuserprofile" @click="deleteUser()">Felhasználó
                                    törlése</button>
                            </div>
                        </div>
                    </div>
